...
void BloodDatabase::writeDataToFile() {
    ...
    outfile << newDonor.donorId << ",    " << newDonor.name <<",    " << newDonor.age << ",    " << newDonor.address << ",    " << newDonor.district << ",    " << newDonor.bloodType << ",    " << newDonor.number << std::endl;
...
void BloodDatabase::deleteDonor(const std::string& donorName) {
    ...
    while (std::getline(inFile, line)) {
        ...
        tempFile << d.donorId << ",    " << d.name << ",    " << d.age << ",    " << d.address << ",    " << d.district << ",    " << d.bloodType << ",    " << d.number << std::endl;
    }
